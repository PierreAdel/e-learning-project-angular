...
export class DbClientService {
  private baseURL: string = "https://e-learning-project-angular-hci-default-rtdb.europe-west1.firebasedatabase.app"
  ...
  login(email: string, password: string) {
    this.httpClient.get<{[key:string]:UserObj}>(`${this.baseURL}/Users.json?orderBy="email"&equalTo="${email}"&limitToFirst=1`).subscribe(responseData => {
